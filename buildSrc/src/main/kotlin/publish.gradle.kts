    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/konstantimp/mustepkotlin/")
                ...
                developers {
                    developer {
                        id.set("konstantimp")
                        name.set("konstantimp")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/konstantimp/mustepkotlin.git")
                    developerConnection.set("scm:git:ssh://github.com/konstantimp/mustepkotlin.git")
                    url.set("https://github.com/konstantimp/mustepkotlin/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/konstantimp/mustepkotlin/issues")
                }
            }
        }
    }
